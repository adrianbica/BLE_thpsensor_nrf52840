#ifndef __LED_CHARACTERISTIC_H__
#define __LED_CHARACTERISTIC_H__

#include "Characteristic.h"
#include "app_util_bds.h"
#include "../char_enc_dec.h"

#ifndef BLE_LED_SERVICE_DIGITAL_DIGITAL_MAX_ITEMS
#define BLE_LED_SERVICE_DIGITAL_DIGITAL_MAX_ITEMS 4
#endif
...
struct LedServiceDigital
{
     ...
     *  - Format:       2bit
     *
     *  See defined values BLE_LED_SERVICE_DIGITAL_DIGITAL_*
     */
    uint8_t digital[BLE_LED_SERVICE_DIGITAL_DIGITAL_MAX_ITEMS];
...
class LedCharacteristic: public Characteristic
{
private:
    LedServiceDigital       initial_value;
public:
    LedCharacteristic(void){};
    LedCharacteristic(uint8_t *initial_value);
