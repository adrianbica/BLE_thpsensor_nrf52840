...
SDK_ROOT := D:/LearningBLE/nRF5_SDK_14.2.0_17b948a
PROJ_DIR := src

$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := THPSensor.ld
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/main.cpp \
  $(PROJ_DIR)/sensor.cpp \
  $(PROJ_DIR)/THPSensor.cpp \
  $(PROJ_DIR)/i2c_bus.cpp \
  $(PROJ_DIR)/timer.cpp \
  $(PROJ_DIR)/char_enc_dec.cpp \
  $(PROJ_DIR)/ble/Characteristic.cpp \
  $(PROJ_DIR)/ble/Service.cpp \
